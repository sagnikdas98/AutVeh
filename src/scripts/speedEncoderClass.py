...
class SpeedEncoder():
    ...
    def __init__(self):
        ...
        ##front##
        self.counter_valF = np.int32(0)
        self.error_valF = 0
        self.Encoder_AF = 0
        self.Encoder_BF = 0

        ##rear##
        self.counter_valR = np.int32(0)
        self.error_valR = 0
        self.Encoder_AR = 0
        self.Encoder_BR = 0
        ...
        ### get parameters #### 
        self.rate_freq = rospy.get_param('/rate',10)
        ...
        self.pub = rospy.Publisher('wheel', Int32, queue_size=10)
    ...
    def publishCB(self):
        ...
        while not rospy.is_shutdown():
            ...
            cnt = np.int32((self.counter_valF + self.counter_valR)/2) 
